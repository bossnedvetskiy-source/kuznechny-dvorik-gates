const VERSION='kuzdvor-offline-2026-09-21-v1';
...
const CORE=['/','/site.css','/site.bundle.js','/calculator.bundle.js','/catalog-enhancements.bundle.js','/hero-gates.jpg','/site-manifest.webmanifest','/site-icon.svg'];
