...
const required = [
  ...
  [enhancements, 'kuzdvor-admin-photo-article-v1', 'remembered photo article'],
  [enhancements, 'kuzdvor-admin-lead-view-v1', 'remembered lead filters'],
  [enhancements, 'photo-actions-armed', 'mobile photo action reveal'],
  [enhancements, '🗂 Каталог', 'clear catalog tab label'],
  [enhancements, 'overflow-x:auto!important', 'scrollable mobile admin tabs'],
  ...
  [adminPrices, 'compact-extra-price', 'compact extra price cards'],
  [adminPrices, 'priceActionBar.hidden = !value', 'price save bar only when dirty'],
  [excelAdmin, 'gateExcelInput', 'Excel file chooser'],
  [excelAdmin, 'Скачать Excel', 'Excel download button'],
  [excelAdmin, 'Загрузить Excel', 'Excel upload button'],
