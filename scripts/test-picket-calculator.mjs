...
assert.match(pickerHtml, /fence-single-real\\.webp/);
assert.match(pickerHtml, /fence-double-real\\.webp/);
assert.ok(fs.existsSync(new URL('../evroshtaketnik/assets/fence-single-real.webp', import.meta.url)));
assert.ok(fs.existsSync(new URL('../evroshtaketnik/assets/fence-double-real.webp', import.meta.url)));
assert.match(pickerHtml, /fence-horizontal-real\\.webp/);
assert.ok(fs.existsSync(new URL('../evroshtaketnik/assets/fence-horizontal-real.webp', import.meta.url)));
