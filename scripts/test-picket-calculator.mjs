...
assert.ok(fs.existsSync(new URL('../evroshtaketnik/assets/fence-single.webp', import.meta.url)));
assert.ok(fs.existsSync(new URL('../evroshtaketnik/assets/fence-double.webp', import.meta.url)));
